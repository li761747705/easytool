            ...
            try
            {
                ...
                foreach (var ni in interfaces)
                {
                    var info = new NetworkInterfaceInfo
                    {
                        ...
                        Speed = ni.Speed,
                        IsUp = ni.OperationalStatus == global::System.Net.NetworkInformation.OperationalStatus.Up
                    };

                    // 获取 IP 地址
                    var ipProps = ni.GetIPProperties();
                    info.IpAddresses = ipProps.UnicastAddresses
                        .Where(a => a.Address.AddressFamily == global::System.Net.Sockets.AddressFamily.InterNetwork)
        ...
        private static string? GetFirstNetworkInterfaceName()
        {
            try
            {
                ...
                var first = interfaces.FirstOrDefault(ni =>
                    ni.OperationalStatus == global::System.Net.NetworkInformation.OperationalStatus.Up &&
                    ni.NetworkInterfaceType != global::System.Net.NetworkInformation.NetworkInterfaceType.Loopback);
