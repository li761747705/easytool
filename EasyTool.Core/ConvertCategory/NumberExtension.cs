...
namespace EasyTool.Extension
{
    ...
    public static class NumberExtension
    {
        ...
        /// <summary>
        /// 计算数值的绝对值
        /// [Obsolete("请直接使用 Math.Abs(value)")]
        /// </summary>
        [Obsolete("请直接使用 Math.Abs(value)", false)]
        ...
        /// <summary>
        /// 判断浮点数是否为 NaN
        /// [Obsolete("请直接使用 float.IsNaN(value)")]
        /// </summary>
        [Obsolete("请直接使用 float.IsNaN(value)", false)]
        ...
        /// <summary>
        /// 判断双精度浮点数是否为 NaN
        /// [Obsolete("请直接使用 double.IsNaN(value)")]
        /// </summary>
        [Obsolete("请直接使用 double.IsNaN(value)", false)]
        ...
        /// <summary>
        /// 判断浮点数是否为无穷大
        /// [Obsolete("请直接使用 float.IsInfinity(value)")]
        /// </summary>
        [Obsolete("请直接使用 float.IsInfinity(value)", false)]
        ...
        /// <summary>
        /// 判断双精度浮点数是否为无穷大
        /// [Obsolete("请直接使用 double.IsInfinity(value)")]
        /// </summary>
        [Obsolete("请直接使用 double.IsInfinity(value)", false)]
        ...
        /// <summary>
        /// 判断浮点数是否为正无穷大
        /// [Obsolete("请直接使用 float.IsPositiveInfinity(value)")]
        /// </summary>
        [Obsolete("请直接使用 float.IsPositiveInfinity(value)", false)]
        ...
        /// <summary>
        /// 判断双精度浮点数是否为正无穷大
        /// [Obsolete("请直接使用 double.IsPositiveInfinity(value)")]
        /// </summary>
        [Obsolete("请直接使用 double.IsPositiveInfinity(value)", false)]
        ...
        /// <summary>
        /// 判断浮点数是否为负无穷大
        /// [Obsolete("请直接使用 float.IsNegativeInfinity(value)")]
        /// </summary>
        [Obsolete("请直接使用 float.IsNegativeInfinity(value)", false)]
        ...
        /// <summary>
        /// 判断双精度浮点数是否为负无穷大
        /// [Obsolete("请直接使用 double.IsNegativeInfinity(value)")]
        /// </summary>
        [Obsolete("请直接使用 double.IsNegativeInfinity(value)", false)]
